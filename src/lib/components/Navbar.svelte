...
{#if mobileMenuOpen}
	...
	>
		<div class="flex justify-between mb-10">
			<a on:click={() => mobileMenuOpen = false} class="logo-{theme} md:fixed top-6 md:border-b pb-1.5 pl-0.5 pr-8 -left-5 md:-rotate-90" href="/">
		...
		<ul class="flex flex-col text-2xl md:ml-12 py-1 gap-6">
			<li><a on:click={() => mobileMenuOpen = false} class="wide-title navbar-link navbar-link-{theme}" class:active={currentUrl.startsWith("/blog")} href="/blog">Blog</a></li>
			<li><a on:click={() => mobileMenuOpen = false} class="wide-title navbar-link navbar-link-{theme}" class:active={currentUrl.startsWith("/casopisi")} href="/casopisi">Časopisi</a></li>
			<li><a on:click={() => mobileMenuOpen = false} class="wide-title navbar-link navbar-link-{theme}" class:active={currentUrl.startsWith("/natjecanja")} href="/natjecanja">Natjecanja</a></li>
		</ul>
